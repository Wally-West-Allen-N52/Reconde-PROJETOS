...
namespace RVRentAgencia.Controllers
{
    public class DestinoController : Controller
    {
        ...
        public DestinoController(ClienteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id_Destino,Estado,Partida,Retorno")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Destino,Estado,Partida,Retorno")] Destino destino)
        {
